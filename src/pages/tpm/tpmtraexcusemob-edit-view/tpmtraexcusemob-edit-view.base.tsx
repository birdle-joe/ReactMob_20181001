...
import { 
  EditForm,
  Righttoolbar,
} from './tpmtraexcusemob-edit-view.control';

export class TPMTRAEXCUSEMobEditViewBase extends IBizEditViewController {
     ...
     * @param {*} value 
     * @param {*} [field={}] 
     * @memberof TPMTRAEXCUSEMobEditViewComponentBase
     */
